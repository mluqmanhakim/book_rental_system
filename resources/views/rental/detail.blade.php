...
<form action="{{ route('update_rental', $rental->id) }}" method="POST">
    ...
    <div class="form-group">
        ...
        <select name="status" class="form-control" id="status">
            ...
            <option value="REJECTED" {{ (old('status', $rental->status) == "REJECTED" ? "selected":"") }}>REJECTED
            </option>
            <option value="ACCEPTED" {{ (old('status', $rental->status) == "ACCEPTED" ? "selected":"") }}>ACCEPTED
            </option>
            <option value="RETURNED" {{ (old('status', $rental->status) == "RETURNED" ? "selected":"") }}>RETURNED
            </option>
        </select>
    </div>
    ...
    <div class="form-group">
        ...
        <input name="deadline" type="datetime-local" class="form-control @error('deadline') is-invalid @enderror"
            id="deadline" placeholder="" value="{{ old('deadline', $deadline) }}">
        @error('deadline')
